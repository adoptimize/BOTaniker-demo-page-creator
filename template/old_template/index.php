...
<body>
    ...
    <div class="content-container">
        ...
        <main class="main-content">
            <div class="area-a">
                <div class="welcome-box">
                    <img src="kunden_logo.png" alt="Kleines Logo">
        ...
        <footer class="footer">
            ...
            <p>&copy; <?= date("Y"); ?> Die BOTaniker&copy; <br><a href="https://www.diebotaniker.de/impressum/" target="dieBotaniker">Impressum</a> <a href="https://www.diebotaniker.de/datenschutz/" target="dieBotaniker">Datenschutz</a></p>
        </footer>
    </div>
